...
const COLUMNS = [
    ...
    { label: 'Issued On', fieldName: IssuedDate.fieldApiName, type: 'text' },
    { label: 'Return Date', fieldName: ReturnDate.fieldApiName, type: 'text' },
    { label: 'Borrowing Now?', fieldName: IsBorrowActive.fieldApiName, type: 'text' },
...
preparedAsset.Status=asset.Book__r.Staus;
console.log('Issued Date' +asset.Issued_Date__c);
preparedAsset.IssuedDate=asset.Id;
