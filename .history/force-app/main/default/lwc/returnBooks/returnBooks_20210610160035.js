...
import NAME_FIELD from '@salesforce/schema/Borrow_Book_Info__c.Book__r.Name';
import Due_Date_FIELD from '@salesforce/schema/Borrow_Book_Info__c.Return_Date__c';
import Overdue_Fees_FIELD from '@salesforce/schema/Borrow_Book_Info__c.Book__r.Overdue_Fees__c';
...
export default class BookList extends LightningElement {
    ...
    columns = COLUMNS;
    @wire(getUserBorrowedBooks) books;
    currentUser = Id;
    selectedBooks;
    error;
connectedCallback(){
