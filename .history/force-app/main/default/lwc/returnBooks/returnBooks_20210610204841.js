...
const COLUMNS = [
    { label: 'Borrow ID', fieldName: 'Borrow_ID', type: 'Id' },
    { label: 'Book ID', fieldName: 'BOOK_ID', type: 'Id' },
    { label: 'Book Name', fieldName: 'NAME', type: 'text' },
    { label: 'Book Status', fieldName: 'Status', type: 'text' },
    { label: 'Issued On', fieldName: 'IssuedDate', type: 'text' },
